...
.br-plan-primary .br-plan-badge { background: var(--br-primary); color: #fff; }
.br-plan-secondary .br-plan-badge { background: var(--br-secondary); color: #000; }
.br-plan-accent .br-plan-badge { background: var(--br-accent); color: #000; }
